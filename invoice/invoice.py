...
class InVoice(commands.Cog):
    ...
    async def on_guild_channel_create(self, vc):
        ...
        embed1.add_field(name="`DJ play`", value="Plays a song with the given name or url e.g DJ play https://www.youtube.com/watch?v=1vrEljMfXYo", inline=True)
        embed1.add_field(name="`DJ np`", value="Shows what song the bot is currently playing.", inline=True)
        embed1.add_field(name="`DJ skip`", value="Skips the currently playing song.", inline=True)
