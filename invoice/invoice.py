...
class InVoice(commands.Cog):
    ...
    async def on_guild_channel_create(self, vc):
        ...
        embed.set_thumbnail(url="https://cdn.discordapp.com/avatars/751844552670969866/9f035363fa69e094c61c9a33e24d4382.png?size=1024")
        embed.set_author(name="Elune", icon_url="https://cdn.discordapp.com/avatars/751844552670969866/9f035363fa69e094c61c9a33e24d4382.png")
        embed.set_footer(text="footer text", icon_url="https://cdn.discordapp.com/embed/avatars/0.png")
        embed.add_field(name="`DJ play`", value="Plays a song with the given name or url e.g DJ play https://www.youtube.com/watch?v=1vrEljMfXYo", inline=True)
        embed.add_field(name="`DJ np`", value="Shows what song the bot is currently playing.", inline=True)
        embed.add_field(name="`DJ skip`", value="Skips the currently playing song.", inline=True)
        embed.add_field(name="`DJ pause`", value="Pauses the currently playing track.", inline=True)
        embed.add_field(name="`DJ np`", value="Shows what song the bot is currently playing.", inline=True)
        embed.add_field(name="`DJ np`", value="Shows what song the bot is currently playing.", inline=True)
