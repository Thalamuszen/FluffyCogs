...
class InVoice(commands.Cog):
    ...
    async def on_guild_channel_create(self, vc):
        ...
        embed1.add_field(name="`zc bitrate`", value="Set a server-wide custom bitrate (in kbps) for yourself that will be used for any channels you join. (Helpful if you have slow internet)", inline=True)
        ...
        embed2.add_field(name="`DJ help`", value="Shows a full list of commands.", inline=True)
