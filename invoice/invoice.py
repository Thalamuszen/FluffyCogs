...
class InVoice(commands.Cog):
    ...
    async def on_guild_channel_create(self, vc):
        ...
        embed1.set_footer(text="footer text", icon_url="https://cdn.discordapp.com/embed/avatars/0.png")
        ...
        embed2 = discord.Embed(title="__**DJ Lucio Bot**__", description="DJ Lucio is a feature rich, easy to use Discord music bot. Supporting many sources of music including YouTube, SoundCloud, Twitch and more. See below for a short list of commands:", color=0x4FE0E0)
        ...
        embed2.set_footer(text="footer text", icon_url="https://cdn.discordapp.com/embed/avatars/0.png")
        embed2.add_field(name="`DJ play`", value="Plays a song with the given name or url e.g DJ play https://www.youtube.com/watch?v=1vrEljMfXYo", inline=True)
